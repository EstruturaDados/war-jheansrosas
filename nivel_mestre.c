...
// Exibe o mapa atual com todos os territórios cadastrados
...
// Inicializa os territórios do jogo com dados pré-definidos
...
// Sorteia uma das missões disponíveis para o jogador
int sorteMissao() {
    return rand() % 2;
}
...
// Verifica se a missão atual foi concluída
...
int main() {
    ...
    do {
        ...
        switch (opcao) {
            case 1: // Seleção dos territórios para a batalha
